...
**这个Mod不兼容Galactic Scale 2！如果和Galatic Scale 2同时使用，该Mod将不会生效！**
...
Build target ：游戏版本 0.9.27.15466 ， BepInEx 版本： 5.4.19 （应该也能够在 5.4.17 版本下正常运行）
...
- 与Galactic Scale 2一同启动时自动停用该Mod以防止冲突
