...
namespace DSPColorfulBuildingGrid
{
    internal static class UIUtility
    {
        ...
        {
            GameObject obj = UnityEngine.Object.Instantiate(Cache.NativeObjectCache.CloseBtn);
        ...
        {
            GameObject go = UnityEngine.Object.Instantiate(Cache.ReassembledObjectCache.SliderWithHandle, parent);
            go.name = name;
